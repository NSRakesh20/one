...
<body>
	...
	<h1 style="color: blue; font-size: 40px;" align="center">THIS IS </h1>
	...
	<h1 style="color: red; font-size: 40px;" align="center">New to jenkins JENKINS</h1>
	<h1 style="color: red; font-size: 40px;" align="center">New to FLM</h1>
